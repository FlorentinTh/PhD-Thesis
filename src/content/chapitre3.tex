...
\subfloat[Capteur de courbure]{
  \includegraphics[width=.30\linewidth]{chapter3/flex_sensor.pdf}
  \label{fig:flex_sensor}
  }
  \hspace*{2cm}
\subfloat[Capteur de force (\acs{FSR})]{
  \includegraphics[width=.30\linewidth]{chapter3/force_sensor.pdf}
...
Avant d'entrer dans le détail des technologies de communication utilisées par les \textit{wearable devices}, il est important de commencer par énoncer les topologies de réseaux existantes dans le domaine du sans-fil. En effet, elles jouent un rôle important dans le bon fonctionnement de la communication réseau et l'identification de leurs différentes caractéristiques va permettre, \textit{a posteriori}, de mieux cibler les besoins pour le développement de nouveaux systèmes. D'après \cite{Tanenbaum2011}, les topologies les plus fréquemment mises en place dans un contexte sans-fil sont :
...
\begin{itemize}[label=\textbullet]
    ...
    \item
        Les \textbf{réseaux maillés} (figure \ref{fig:topo_mesh}) permettent l'échange de données entre n'importe quels n\oe{}uds du réseau sans passer par un n\oe{}ud central. La communication est bidirectionnelle et chaque n\oe{}ud peut-être relié à plusieurs autres n\oe{}uds qui composent le réseau.
    \item
...
\begin{figure}[H]
    \centering
    \subfloat[Diffusion]{
        \includegraphics[width=.22\linewidth]{chapter3/topo_broadcast.pdf}
        \label{fig:topo_broadcast}
    }
    \hspace*{.2\linewidth}
    \subfloat[Étoile]{
        \includegraphics[width=.24\linewidth]{chapter3/topo_star.pdf}
        \label{fig:topo_star}
    }
    \\[30pt]
    \subfloat[Pair-à-Pair]{
		\includegraphics[width=.32\linewidth]{chapter3/topo_p2p.pdf}
		\label{fig:topo_p2p}
    }
    \hspace*{.1\linewidth}
	\subfloat[Maillé]{
		\includegraphics[width=.32\linewidth]{chapter3/topo_mesh.pdf}
		\label{fig:topo_mesh}
    }
    \\[30pt]
    \subfloat[Mode scan]{
		\includegraphics[width=.24\linewidth]{chapter3/topo_scan.pdf}
		\label{fig:topo_scan}
    }
...
\begin{table}[H]
  ...
  \resizebox{\columnwidth}{!}{
      \begin{tabular}{c|c|c|c|c|c|}
          ...
          \multicolumn{1}{|c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Wi-Fi\\[-15pt] (812.11n)\end{tabular}}} & 70 m & 150 - 600 MB/s & $\approx 1\: ms$ & 150 mA & 100 mA \\ \hline
          \multicolumn{1}{|c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Wi-Fi\\[-15pt] (812.11ac)\end{tabular}}} & 35 m & 433 - 2600 MB/s & $\approx 1\: ms$ & 150 mA & 100 mA \\ \hline
          \multicolumn{1}{|c|}{\textbf{BLE}} & 250 m & 1 - 2 MB/s & $\approx 1\: ms$ & 15 mA & 25 $\mu$A \\ \hline
          \multicolumn{1}{|c|}{\textbf{ZigBee}} & > 1 km & 250 kB/s & $\approx 1\: s$ & 30 mA & 30 mA \\ \hline
          \multicolumn{1}{|c|}{\textbf{NFC}} & 0.1 m & 400 kB/s & $\approx 1\: s$ & 50 mA & 50 mA \\ \hline
      \end{tabular}
  }
\end{table}
