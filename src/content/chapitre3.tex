...
\begin{figure}[H]
	...
	\subfloat[Échange de données en mode connexion]{
		\includegraphics[width=.9\linewidth]{ble_connect_process.pdf}
...
\begin{figure}[H]
	...
	\subfloat[Requête \acs{SOAP}]{
		\includegraphics[width=.85\linewidth]{soap_req.pdf}
		\label{fig:soap_req}
    }
    \\[30pt]
	\subfloat[Réponse \acs{SOAP}]{
		\includegraphics[width=.85\linewidth]{soap_res.pdf}
		\label{fig:soap_res}
    }
