...
\begin{figure}[H]
    \centering
	\subfloat[RF]{
		\includegraphics[width=.8\linewidth]{results_wear_v1_rf.pdf}
		\label{fig:results_wear_v1_rf}
    }
    \\[20pt]
	\subfloat[KNN]{
		\includegraphics[width=.8\linewidth]{results_wear_v1_knn.pdf}
...
\begin{figure}[H]
    \centering
	\subfloat[RF]{
		\includegraphics[width=.8\linewidth]{pos_ind_rf_wear_1.pdf}
		\label{fig:pos_ind_rf_wear_1}
    }
    \\[20pt]
	\subfloat[KNN]{
		\includegraphics[width=.8\linewidth]{pos_ind_knn_wear_1.pdf}
...
\begin{figure}[H]
    \centering
	\subfloat[RF]{
		\includegraphics[width=.8\linewidth]{user_ind_rf_wear_1.pdf}
		\label{fig:user_ind_rf_wear_1}
    }
    \\[20pt]
	\subfloat[KNN]{
		\includegraphics[width=.8\linewidth]{user_ind_knn_wear_1.pdf}
		\label{fig:user_ind_knn_wear_1}
    }
    \caption{Indépendance de posisition.}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.8\linewidth]{results_wear_v2.pdf}
        \caption{Résultats.}
