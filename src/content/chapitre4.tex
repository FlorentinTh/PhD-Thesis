...
Afin de valider que la méthode de reconnaissance des types de sols proposée dans ce premier travail est suffisamment précise et fiable, il a été nécessaire de produire plusieurs jeux de données composés des caractéristiques discriminantes et étiquetés distinctement. La liste de ceux-ci est fournie par le tableau \ref{tab:datasets}. En effet, les expérimentations faites par les participants ont seulement permis l'échantillonnage de données brutes à une fréquence stabilisée à $60\:Hz$.
