\begin{acronym}[openHAB]
  ...
  \acro{ARFF}{Attribute-Relation File Format}
	...
	\acro{DRDB}{Distributed Replicated Block Device}
  ...
  \acro{PPG}{photopléthysmographie}
  ...
  \acro{YALE}{Yet Another Learning Environment}
